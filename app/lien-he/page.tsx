    ...
    <div className="bg-slate-50 min-h-screen pb-20 font-sans text-slate-600 relative overflow-x-hidden">
      ...
      <div className="container mx-auto px-4 -mt-16 relative z-20">
        ...
        <div className="grid lg:grid-cols-12 gap-8 mb-12">
          ...
          {/* Sticky: Giúp cột này trượt theo khi cuộn trang, lấp đầy khoảng trống */}
          <div className="lg:col-span-5 space-y-6 h-fit lg:sticky lg:top-28">
             ...
             {/* Block 2: Kênh thông tin (Vẫn ở cột trái để lấp đầy chiều cao) */}
             <div className="bg-gradient-to-br from-blue-900 to-indigo-950 p-6 md:p-8 rounded-2xl shadow-xl text-white">
                ...
                <div className="space-y-3">
                    ...
                    <Link href="https://www.facebook.com/apc.umt" target="_blank" className="flex items-center gap-3 p-3 rounded-xl bg-white/5 hover:bg-white/10 transition group border border-white/5 hover:border-white/20">
                        <div className="bg-white/10 p-1.5 rounded-lg text-orange-200 group-hover:text-white"><Facebook size={18} /></div>
        ...
        {/* 4. MAP SECTION (FULL WIDTH Ở DƯỚI CÙNG) */}
        {/* Vị trí này làm cho layout cân đối và chuyên nghiệp hơn hẳn */}
        <div className="bg-white p-3 rounded-3xl shadow-xl shadow-blue-900/5 border border-slate-100 relative group">
            <div className="w-full h-[400px] md:h-[500px] rounded-2xl overflow-hidden relative">
                {/* Iframe Google Map Chính xác vị trí UMT */}
                <iframe 
                    src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3919.6696584219863!2d106.7749817757057!3d10.75992235949539!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x317525b5291e2327%3A0x749a45833b7573d5!2zVHLGsOG7nW5nIMSQ4bqhaSBo4buNYyBRdeG6o24gbMO9IHbDoCBDw7RuZyBuZ2jhu4cgVFAuSENNIChVTVQp!5e0!3m2!1svi!2s!4v1710302300000!5m2!1svi!2s"
                    width="100%" 
                    height="100%" 
                    style={{border:0}} 
                    allowFullScreen 
