  ...
  return (
    <div className="bg-slate-50 min-h-screen pb-20 font-sans">
      ...
      <div className="bg-blue-900 text-white py-16 relative overflow-hidden">
        <div className="absolute top-0 right-0 w-96 h-96 bg-white/5 rounded-full blur-3xl -translate-y-10 translate-x-10"></div>
        <div className="container mx-auto px-4 relative z-10 text-center">
          <h1 className="text-3xl md:text-5xl font-bold mb-4 uppercase">Thể lệ cuộc thi</h1>
      ...
      <div className="container mx-auto px-4 -mt-8 relative z-20 max-w-5xl space-y-12">
        ...
        <section className="bg-white rounded-2xl p-8 shadow-sm border border-slate-200">
          <div className="flex items-center gap-3 mb-6 border-b border-slate-100 pb-4">
            ...
            <h2 className="text-2xl font-bold text-slate-900">Điều 1: Mục đích & Phạm vi</h2>
          </div>
          
          <div className="grid md:grid-cols-2 gap-8 text-slate-700">
            <div>
              <h3 className="font-bold text-blue-800 mb-3 uppercase text-sm tracking-wider">1. Mục đích</h3>
              <ul className="space-y-3 list-disc pl-5 marker:text-blue-500 text-sm md:text-base">
            ...
            <div>
              <h3 className="font-bold text-blue-800 mb-3 uppercase text-sm tracking-wider">2. Phạm vi</h3>
        ...
        {/* Điều 2: Đối tượng & Bảng thi (Chỉ nói về Bảng thi) */}
        <section className="bg-white rounded-2xl p-8 shadow-sm border border-slate-200">
          <div className="flex items-center gap-3 mb-6 border-b border-slate-100 pb-4">
            <div className="w-10 h-10 bg-green-100 rounded-lg flex items-center justify-center text-green-700">
              <Users size={20} />
            </div>
            <h2 className="text-2xl font-bold text-slate-900">Điều 2: Đối tượng & Bảng thi</h2>
          </div>
          ...
          <div className="grid md:grid-cols-2 gap-6">
            {/* Bảng A */}
            <div className="border-2 border-blue-100 bg-blue-50/30 rounded-xl p-6 relative hover:border-blue-400 transition group h-full">
  
              <h3 className="text-xl font-bold text-blue-900 mb-4">Bảng A</h3>
            ...
            {/* Bảng B */}
            <div className="border-2 border-teal-100 bg-teal-50/30 rounded-xl p-6 relative hover:border-teal-400 transition group h-full">

              <h3 className="text-xl font-bold text-teal-900 mb-4">Bảng B</h3>
              <ul className="space-y-3 text-slate-700 text-sm">
                <li className="flex gap-2 items-start">
        ...
        <section className="bg-white rounded-2xl p-8 shadow-sm border border-slate-200">
           <div className="flex items-center gap-3 mb-8 border-b border-slate-100 pb-4">
            ...
            <h2 className="text-xl md:text-2xl font-bold text-slate-900">Điều 3: Nội dung, Phương thức & Thời gian</h2>
          </div>
          ...
          <div className="mb-10 space-y-6">
             ...
             <div className="bg-slate-50 p-6 rounded-xl border border-slate-100">
                ...
                <ul className="list-disc pl-5 text-slate-700 space-y-2 text-sm md:text-base marker:text-purple-500">
        ...
        {/* Điều 4: Đăng ký dự thi (Mới) */}
        <section className="bg-white rounded-2xl p-8 shadow-sm border border-slate-200">
           <div className="flex items-center gap-3 mb-6 border-b border-slate-100 pb-4">
            <div className="w-10 h-10 bg-cyan-100 rounded-lg flex items-center justify-center text-cyan-700">
              <PenTool size={20} />
            </div>
            <h2 className="text-2xl font-bold text-slate-900">Điều 4: Đăng ký dự thi</h2>
          </div>
          <div className="space-y-4 text-slate-700 text-sm md:text-base bg-cyan-50/50 p-6 rounded-xl border border-cyan-100">
             <ul className="space-y-4 list-disc pl-5 marker:text-cyan-600">
        ...
        <section className="bg-white rounded-2xl p-8 shadow-sm border border-slate-200">
          <div className="flex items-center gap-3 mb-6 border-b border-slate-100 pb-4">
            ...
            <h2 className="text-2xl font-bold text-slate-900">Điều 5: Quyền lợi & Giải thưởng</h2>
          </div>
            ...
            <table className="w-full text-sm text-left text-slate-600">
                <thead className="text-xs text-slate-700 uppercase bg-slate-100 border-b">
                    <tr>
                        ...
                        <th className="px-6 py-3 text-center">Bảng A</th>
                        <th className="px-6 py-3 text-center">Bảng B</th>
                        <th className="px-6 py-3 text-right">Học bổng (Toàn khóa)</th>
                    </tr>
                </thead>
                <tbody>
                    <tr className="bg-white border-b hover:bg-slate-50">
                        <td className="px-6 py-4 font-bold text-slate-900">Giải Đặc Biệt</td>
                        <td colSpan={2} className="px-6 py-4 text-center italic text-slate-500">01 giải chung cho cả 2 bảng</td>
                        <td className="px-6 py-4 text-right font-bold text-blue-600">100% (Global)</td>
                    </tr>
                    <tr className="bg-slate-50/50 border-b hover:bg-slate-50">
                        <td className="px-6 py-4 font-bold">Giải Nhất</td>
                        <td className="px-6 py-4 text-center">02</td>
                        <td className="px-6 py-4 text-center">02</td>
                        <td className="px-6 py-4 text-right font-bold text-blue-500">60% (Unique)</td>
                    </tr>
                    <tr className="bg-white border-b hover:bg-slate-50">
                        <td className="px-6 py-4 font-bold">Giải Nhì</td>
                        <td className="px-6 py-4 text-center">03</td>
                        <td className="px-6 py-4 text-center">03</td>
                        <td className="px-6 py-4 text-right font-bold text-blue-400">50% (Liberal)</td>
                    </tr>
                    <tr className="bg-slate-50/50 border-b hover:bg-slate-50">
                        <td className="px-6 py-4">Giải Ba</td>
                        <td className="px-6 py-4 text-center">05</td>
                        <td className="px-6 py-4 text-center">05</td>
                        <td className="px-6 py-4 text-right text-slate-400">-</td>
                    </tr>
                    <tr className="bg-white hover:bg-slate-50">
                        <td className="px-6 py-4">Khuyến Khích</td>
          ...
          <div className="bg-yellow-50 p-5 rounded-xl text-sm text-slate-700 space-y-3 border border-yellow-100">
        ...
        <section className="bg-white rounded-2xl p-8 shadow-sm border border-slate-200">
           <div className="flex items-center gap-3 mb-6 border-b border-slate-100 pb-4">
            ...
            <h2 className="text-2xl font-bold text-slate-900">Điều 6: Kinh phí tổ chức</h2>
          </div>
        ...
        <section className="bg-white rounded-2xl p-8 shadow-sm border border-slate-200">
           <div className="flex items-center gap-3 mb-6 border-b border-slate-100 pb-4">
            ...
            <h2 className="text-2xl font-bold text-slate-900">Điều 7: Các quy định khác</h2>
          </div>
          <ul className="space-y-4 text-slate-700 list-decimal pl-5 marker:font-bold marker:text-slate-500 text-sm md:text-base">
